SURAHS = [
    ...
    (3,   "آل عمران",        "Aal-Imran",         "Family of Imran",       200, "Medinan"),
...
SURAH_AUDIO_URLS = {
    i: f"https://server8.mp3quran.net/afs/{i:03d}.mp3"
...
SURAH_AUDIO_MINSHAWI = {
    i: f"https://server7.mp3quran.net/mnshawy/{i:03d}.mp3"
    for i in range(1, 115)
}

SURAH_AUDIO_HUDHAIFY = {
    i: f"https://server8.mp3quran.net/hudhify/{i:03d}.mp3"
    for i in range(1, 115)
}

RECITERS = {
    "alafasy":  {"name": "Mishary Alafasy",    "urls": SURAH_AUDIO_ALAFASY},
    "minshawi": {"name": "Mohamed Al-Minshawi","urls": SURAH_AUDIO_MINSHAWI},
    "hudhaify": {"name": "Ali Al-Hudhaify",    "urls": SURAH_AUDIO_HUDHAIFY},
}
